...
public enum Zone {
    SAFE(ChatColor.DARK_GREEN, "Better safe than sorry, no worry!"), WILD(ChatColor.YELLOW, "Welcome to the WILD!"), GUILD(ChatColor.DARK_BLUE, "Here lives "), WAR(ChatColor.DARK_RED, "This means WAR!");
